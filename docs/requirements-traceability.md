...
| D06 | T01 | 正式项目台账回归与补缺 | D06 项目编号、经营实体、状态、申请边界和状态历史验收 | PASS（FINAL 五组全部通过，R01 PASS，R03 已完成；v53-v57 连续且校验和一致，测试数据残留为 0；D07 已解锁但未开始） | [D06 交接](handoffs/D06-project-ledger.md) |

...
- 2026-09-03：在项目负责人明确授权的 Supabase 项目中，已执行 D02 匿名人员和部门夹具并核验成功：10 名人员、3 个部门、13 条夹具登记记录。
- 该项目控制台显示 `main Production` 标签，不能视为满足本文件“独立测试数据库”的环境隔离要求；后续测试账号、项目状态、文件桶和消息替身夹具仍应优先迁移至独立测试项目后再建立。

...
const TrainingAdmissionOperations = {
  ...
  async load() {
    ...
    const results = await Promise.all([
      ...
      sb.from('training_admissions').select('id, project_id, employee_id, package_id, status, exam_score, exam_attempts, final_signed_at, site_confirmed_at, valid_until, blocked_reason, retrain_required, retrain_reason, training_cycle_no, created_at').order('created_at', { ascending: false }),
